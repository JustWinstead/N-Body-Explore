...
def updateParticles(masses, positions, velocities, dt):
    ...
    assert(startingVelocities.shape == startingPositions.shape), "startingVelocities and startingPositions have different shapes!"
    assert(len(masses) == nParticles), "Length of masses differs from first dimension of startingPositions!"
